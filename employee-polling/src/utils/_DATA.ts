...
import Question from "../models/data/question"
...
function formatQuestion ({ optionOneText, optionTwoText, author } : { optionOneText: string, optionTwoText: string, author: User }) {
  return {
    id: generateUID(),
    timestamp: Date.now(),
    author: author.id,
